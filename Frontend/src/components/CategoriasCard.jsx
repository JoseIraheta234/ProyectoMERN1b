...
import { Edit2, Trash2, MapPin, FileText, Image, Eye, EyeOff, Building2 } from 'lucide-react';

const CategoriasCard = ({ branch, onEdit, onDelete }) => {
    ...
    return (
      <div className="bg-white rounded-3xl shadow-lg p-6 border border-gray-100">
        <div className="text-center text-gray-500">
          ...
          <p>No se encontraron datos de la sucursal</p>
        </div>
      </div>
    );
  }
  ...
  const branchName = branch.name || 'Sucursal sin nombre';
  ...
  return (
    <div className="group relative bg-white rounded-3xl shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 overflow-hidden border border-gray-100">
      ...
      <div className="relative p-6 space-y-4">
        {/* Branch Name with gradient text */}
        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          <div className="bg-gradient-to-br from-purple-50 to-pink-50 rounded-2xl p-4 border border-purple-100 group-hover:shadow-md transition-all duration-300">
            ...
            <p className="text-lg font-bold text-purple-700">
              {branchImage && branchImage.trim() !== '' ? 'Sí' : 'No'}
            </p>
          </div>
        </div>

        {/* Image Preview */}
        {branchImage && branchImage.trim() !== '' && (
        ...
        <div className="flex space-x-3 pt-2">
          ...
          <button
            onClick={() => onDelete && onDelete(branchId)}
