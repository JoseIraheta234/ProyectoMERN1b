...
import { X, Save, Loader2, Package, DollarSign, Archive, FileText } from 'lucide-react';
      ...
      <div className="relative p-8">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="group">
            ...
            <div className="relative">
              <textarea
                ...
                onChange={handleChange}
                rows={4}
                className="w-full px-6 py-4 border-2 border-gray-200 hover:border-gray-300 rounded-2xl focus:ring-4 focus:ring-purple-500 focus:ring-opacity-20 focus:border-purple-500 transition-all duration-300 bg-white shadow-sm hover:shadow-md resize-none"
                placeholder="Describe las características principales del producto..."
              />
              <div className="absolute inset-x-0 bottom-0 h-1 bg-gradient-to-r from-purple-500 to-pink-500 rounded-b-2xl transform scale-x-0 group-focus-within:scale-x-100 transition-transform duration-300"></div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {/* Price Field */}
            <div className="group">
              <label htmlFor="price" className="flex items-center space-x-2 mb-3">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  step="0.01"
                  min="0"
                  className={`w-full pl-12 pr-6 py-4 border-2 rounded-2xl focus:ring-4 focus:ring-emerald-500 focus:ring-opacity-20 focus:border-emerald-500 transition-all duration-300 bg-white shadow-sm hover:shadow-md ${
                    errors.price ? 'border-red-400 focus:border-red-500 focus:ring-red-500 focus:ring-opacity-20' : 'border-gray-200 hover:border-gray-300'
                  }`}
                  placeholder="0.00"
                />
                <div className={`absolute inset-x-0 bottom-0 h-1 bg-gradient-to-r from-emerald-500 to-green-500 rounded-b-2xl transform scale-x-0 group-focus-within:scale-x-100 transition-transform duration-300 ${errors.price ? 'from-red-500 to-pink-500' : ''}`}></div>
              </div>
              {errors.price && (
                <div className="mt-2 p-3 bg-red-50 border border-red-200 rounded-xl">
                  <p className="text-sm text-red-600 flex items-center space-x-2">
            ...
            {/* Stock Field */}
            <div className="group">
              <label htmlFor="stock" className="flex items-center space-x-2 mb-3">
              ...
              <div className="relative">
                <input
                  ...
                  onChange={handleChange}
                  min="0"
                  className={`w-full px-6 py-4 border-2 rounded-2xl focus:ring-4 focus:ring-amber-500 focus:ring-opacity-20 focus:border-amber-500 transition-all duration-300 bg-white shadow-sm hover:shadow-md ${
                    errors.stock ? 'border-red-400 focus:border-red-500 focus:ring-red-500 focus:ring-opacity-20' : 'border-gray-200 hover:border-gray-300'
                  }`}
                  placeholder="0"
                />
                <div className={`absolute inset-x-0 bottom-0 h-1 bg-gradient-to-r from-amber-500 to-orange-500 rounded-b-2xl transform scale-x-0 group-focus-within:scale-x-100 transition-transform duration-300 ${errors.stock ? 'from-red-500 to-pink-500' : ''}`}></div>
